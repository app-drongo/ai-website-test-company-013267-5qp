...
const DEFAULT_FOOTER = {
  ...
  companyDescription:
    'Delivering innovative technology solutions that drive business growth and digital transformation. Trusted by leading enterprises worldwide for our expertise in cloud computing, AI, and software development.',
  contactEmail: 'contact@testcompany.com',
  contactPhone: '+1 (555) 987-6543',
  contactAddress: '456 Innovation Drive, Tech Park, CA 94105',
  newsletterTitle: 'Tech Insights Newsletter',
  newsletterPlaceholder: 'Enter your business email',
  newsletterDisclaimer:
    'Get weekly insights on technology trends and industry updates. Unsubscribe anytime.',
  ...
  social1Href: 'https://twitter.com/testcompany',
  social2Href: 'https://facebook.com/testcompany',
  social3Href: 'https://instagram.com/testcompany',
  social4Href: 'https://linkedin.com/company/testcompany',
  social5Href: 'https://github.com/testcompany',
} as const;
  ...
  const footerSections = [
    {
      ...
      links: [
        { name: 'Cloud Services', href: '/cloud-services', editableId: 'link-footer-cloud' },
        { name: 'AI & Machine Learning', href: '/ai-solutions', editableId: 'link-footer-ai' },
        {
          name: 'Custom Software',
          href: '/software-development',
          editableId: 'link-footer-software',
        },
        {
        ...
        { name: 'API Integration', href: '/api-services', editableId: 'link-footer-api' },
    ...
    },
    {
      ...
      links: [
        ...
        { name: 'Case Studies', href: '/case-studies', editableId: 'link-footer-cases' },
