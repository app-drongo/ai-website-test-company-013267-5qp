...
const DEFAULT_HERO = {
  ...
  title: 'Test your ideas with',
  titleHighlight: 'confidence & speed',
  description:
    'Experience our streamlined testing platform designed for rapid prototyping and validation. Perfect for developers, designers, and product teams.',
  features: [
  ...
  imageAlt: 'Testing dashboard preview',
  statsLabel1: 'Success Rate',
  statsValue1: '99.9% uptime',
  statsLabel2: 'Speed',
  statsValue2: '< 100ms load',
} as const;
